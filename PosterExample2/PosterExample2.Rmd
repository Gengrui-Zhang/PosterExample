---
title: An instruction for creating a stylish poster
author:
  - name: Jimmy Zhang
    affil: 1
    twitter: jz_123
    email: gengruiz@usc.edu
    orcid: 0000-0002-2062-6620
    main: true
affiliation:
  - num: 1
    address: Department of Psychology, University of Southern California
primary_colour: "#E9E4D4"
main_findings:
  - "Make **better posters** with RMarkdown + *posterdown*."
  - '![](https://github.com/Gengrui-Zhang/PosterExample/blob/main/gc3_logo.png?raw=true){.main_pic}'
logoleft_name: '![](https://github.com/Gengrui-Zhang/PosterExample/blob/main/qr_code.png?raw=true){.main-img-left}'
logoright_name: '![](https://github.com/Gengrui-Zhang/PosterExample/blob/main/usc_logo.png?raw=true){.main-img-right}'
...
```{r r object, include=FALSE}
mean_g1 <- 50
```

We can report the mean of group 1 using the reproducible code, $\bar X_{g1} =$ `r mean_g1`. It prints out 15 now. This number would change if we can change the number assigned to `mean_g1`. 
