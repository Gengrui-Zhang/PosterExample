...
main_findings:
  - "Make **better posters** with RMarkdown + *posterdown*, presented by Jimmy"
  - '![](https://github.com/Gengrui-Zhang/PosterExample/blob/main/GC-3%20Flyer.png?raw=true){.main_pic}'
